...
module.exports = (deployer, network, accounts) => {
    deployer.then(async () => {
		...
		await deployExercises(deployer, network, accounts);
...
async function deployExercises(deployer, network, accounts) {
	Exercice=await ExerciceSolution.new()
}

async function deployRecap(deployer, network, accounts) {
	//console.log("TDToken " + TDToken.address)
	//console.log("Evaluator " + Evaluator.address)
	console.log("Exercice " + Exercice.address)
}
